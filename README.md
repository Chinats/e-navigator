...
面接の日程を調整するためのアプリケーションを作っていただきます。
そして、ここで作ったアプリケーションは、あなたの面接日程を調整するために実際に使います。
...
- 前編
  ...
  - 登録したユーザーのプロフィール編集機能
- 後編
  - 自分の面接日程の表示・登録・編集・削除機能
  - 面接官が面接日程を承認 or 拒否するための機能
  - 面接日程を知らせるためのメール送信機能
